...
echo '<form name="form1" method="post"> 
      <table style="border-style:none" align="center">
             <tr>
                <td colspan="7" height="30" align="center" valign="middle" bgcolor="#000000"><font color="#ffffff" size="3" face="Arial, Helvetica, sans-serif"><strong><left>REPORTE DE INDICADORES CONSOLIDADO CMI NACIONAL</left></strong></font>
                </td>
          </tr>
          ...
          <tr>
				<td colspan="7" width="140" height="30">
